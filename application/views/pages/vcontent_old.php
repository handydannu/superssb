...
<div class="main-content">
    <div class="container2" style="padding-left:30px;padding-right:15px;background-image: url(http://banksulselbardev.com/assets/img/bg3.png);background-position:left-top;background-repeat:repeat-x">
              ...
              <div class="about-side-nav-wrap">
                <?php
                  $content_corporate= array('visi-misi', 'nilai-nilai', 'logo', 'identitas-perusahaan', 'sejarah-singkat','dewan-komisaris',
                    'direksi', 'pemegang-saham', 'dewan-pengawas-syariah', 'pimpinan-grup', 'struktur-organisasi', 'penghargaan',
                    'akses-informasi', 'sumber-daya-manusia', 'teknologi-informasi', 'manajemen-resiko');
                  $content_layanan = array('simpeda', 'tapemda-pelajar', 'tapemda-pensiunan', 'tapemda-sayang-petani', 'tampan', 'tabunganku',
                    ...
                    'kredit-koperasi', 'kredit-kepada-pemerintah-daerah-pemda', 'jasa-bank', 'syariah', 'syariah-investasi', 'atm', 'garansi-bank', 'produk-dan-jasa-uus');
                  ...
                  if($active_menu == in_array($active_menu, $content_corporate)){
                    ?>
                      <ul class="about-side-nav">
                        ...
                        <li <?= ($active_menu=='manajemen-resiko') ? "class='side-nav-single active'":"" ?>><a href="<?php echo site_url('page/manajemen-resiko')?>">Manajemen Resiko</a></li>
                    ...
                    ?>
                      <ul class="about-side-nav">
                        ...
                        <li><a href="<?php echo site_url('page/manajemen-resiko')?>">Manajemen Resiko</a></li>
                        <li class="side-nav-single dropdown"><a href="javascript:void(0)">Jaringan</a>
                          <ul class="about-side-nav anakan">
                    ...
                    ?>
                      <ul class="about-side-nav">
                        ...
                        <li class="side-nav-single dropdown active"><a href="javascript:void(0)">Syariah</a>
                          <ul class="about-side-nav anakan">
                            <a href="<?php echo site_url('page/syariah')?>"><li <?= ($active_menu=='syariah') ? "class='side-nav-single active'":"" ?>>Pembiayaan</li></a>
                            <a href="<?php echo site_url('page/syariah-investasi')?>"><li <?= ($active_menu=='syariah-investasi') ? "class='side-nav-single active'":"" ?>>Simpanan Investasi Nasabah</li></a>
                          </ul>
                        </li>
                        ...
                        <li <?= ($active_menu=='produk-dan-jasa-uus') ? "class='side-nav-single active'":"" ?>><a href="<?php echo site_url('page/produk-dan-jasa-uus')?>">Produk dan Jasa UUS</a></li>
                      </ul>
                    <?php
                  }
                  else{
