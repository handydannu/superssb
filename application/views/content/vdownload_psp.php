<div class="breadcrumb-temp">
        <div class="container">
            <span class="canal-title">Informasi</span><span class="canal-subtitle">&nbsp;/&nbsp;Download&nbsp;/&nbsp;Pengumuman Sekretaris Perusahaan</span>
        </div>
    </div>
                ...
                <?php
                    if($yearlist->num_rows()>0) {
                        foreach ($yearlist->result() as $rows) {
                            ...
                            ?>
                                <li class="<?php echo $cls?>" id="<?php echo $now?>" value="<?php echo $tahun?>"><a href="<?php echo site_url('download/psp/'.$rows->doc_year)?>"><?=$rows->doc_year ?></a></li>
                            <?php
                            $tahun++;
                        }
                    }
