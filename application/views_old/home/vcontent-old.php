    ...
    <div class="bottom-content-wrapper"><!--Bottom contents-->
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6"><!--Sejarah singkat & Testimonial-->
                        ...
                        <div class="home-berita-single">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <a href="<?php echo $b_url; ?>"><img width="160" height="105" src="<?php echo $image_url; ?>" onError="this.src='<?php echo images_uri(); ?>logo-banksulselbar-sm.jpg'"></a>
                                </div>
