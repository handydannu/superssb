            ...
            <center>
                <?php
                    foreach ($articles as $post) {
                        ...
                        ?>
                            <iframe class="video-embed" width="100%" height="630" src="https://www.youtube.com/embed/<?php echo $post['c_youtube_id'] ?>?rel=0&showinfo=0&color=white&iv_load_policy=3" frameborder="0" allowfullscreen></iframe>
