    ...
    <div class="main-content"><!--Main Content goes here-->
        <div class="container kontak">   
            ...
            <div class="map-wrapper"><!--Google Maps-->
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3973.785586450616!2d119.4074607148437!3d-5.138192853403248!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dbf02ae82311a2b%3A0xac0bb20e17aa3314!2sKantor+Cabang+Barru+Bank+Sulsel!5e0!3m2!1sen!2s!4v1469592708040" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div><!--//Google Maps-->
            ...
            <div class="contact-forms">
                <div class="row">
                    ...
                    <div class="col-lg-3"><!--Address and Phone-->
                    ...
                    <div class="col-lg-9"><!--Forms-->
                        <div class="forms">
                            ...
                            echo form_open_multipart('kontak/add', $attributes)?>
                              ...
                              <button type="submit" class="btn btn-default btn-fullwidth">KIRIM</button>
                            <?php echo form_close();?>
                        </div>
                    </div><!--//Forms-->
