...
elseif ($_SERVER['HTTP_HOST']=='banksulselbar.co.id' && $config['doc_root'] == 'http'){
...
elseif ($_SERVER['HTTP_HOST']=='banksulselbar.co.id' && $config['doc_root'] == 'https'){
    $config['server_url'] = 'https://banksulselbar.co.id/';
    $config['doc_root']   = 'https://banksulselbar.co.id/';
    $config['root_dir']   = '/home/bankssb/public_html/';
    define('DOCROOT', '/home/bankssb/public_html/');
}
...
$config['template_uri']       = $config['server_url'] .'assets/';
$config['images_uri']         = $config['server_url'] .'assets/images/';
