...
class Contents_model extends CI_Model
{
	...
	function get_single_content($ID)
	{
		...
		$this->db->select('c_id, c_publish_date, c_subtitle, c_title, c_summary, c_content, c_images_content, c_images_caption, c_type, c_source, c_author_name, c_hits, c_created_date, c_content_type, c_youtube_url, c_youtube_id, 
