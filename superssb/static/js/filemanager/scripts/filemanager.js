...
var selectItem = function(data) {
	...
	// ganti dg ini
	//var url = 'http://' + window.location.hostname + '/images-data/library/' + data['Filename'];
	var url = 'https://' + window.location.hostname + '/images-data/images/library/' + data['Path'].replace(fileRoot,"");
