...
class Jaringan_model extends CI_Model
{
	...
	function get_kantor_cabang()
	{
		...
		$_sql_where 	= array();
		$sql_where 		= '';
		$cols 			= array( "branch_id","","branch_name","branch_address","branch_phone","branch_fax","branch_created","branch_status" );
		$sort 			= "desc";
	...
	function get_kantor_kas()
	{
		...
		$_sql_where 	= array();
		$sql_where 		= '';
		$cols 			= array( "kas_id","","kas_name","kas_address","kas_phone","kas_fax","kas_created","kas_status" );
		$sort 			= "desc";
	...
	function get_payment_point()
	{
		...
		$_sql_where 	= array();
		$sql_where 		= '';
		$cols 			= array( "pp_id","","pp_location","pp_address","pp_phone","pp_fax","pp_created","pp_status" );
		$sort 			= "desc";
	...
	function get_office_channeling()
	{
		...
		$_sql_where 	= array();
		$sql_where 		= '';
		$cols 			= array( "oc_id","","oc_name","oc_address","oc_phone","oc_fax","oc_created","oc_status" );
		$sort 			= "desc";
	...
	function get_mobil_kas()
	{
		...
		$_sql_where 	= array();
		$sql_where 		= '';
		$cols 			= array( "mk_id","","mk_name","mk_address","mk_created","mk_status" );
		$sort 			= "desc";
	...
	public function update_office_channeling($data, $ID)
	{
		$ID = $this->db->escape_str($ID);
		$data = $this->master_model->escape_all($data);

		$this->db->where('oc_id', $ID);
		$this->db->update('office_channeling', $data);
		return $this->db->affected_rows();
	}

	public function update_mobil_kas($data, $ID)
	{
		$ID = $this->db->escape_str($ID);
		$data = $this->master_model->escape_all($data);

		$this->db->where('mk_id', $ID);
		$this->db->update('mobil_kas', $data);
		return $this->db->affected_rows();
	}
	...
	function get_office_channeling_byid($id)
	{
		$id = $this->db->escape_str($id);

		$this->db->select('*');
		$this->db->from('office_channeling');
		$this->db->where('oc_id', $id);
		$prod = $this->db->get();
	...
	function get_mobil_kas_byid($id)
	{
		$id = $this->db->escape_str($id);

		$this->db->select('*');
		$this->db->from('mobil_kas');
		$this->db->where('mk_id', $id);
		$prod = $this->db->get();
