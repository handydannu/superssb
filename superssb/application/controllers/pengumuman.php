...
class Pengumuman extends CI_Controller {
	...
	function index()
	{
		...
		$mainData['bottom_js'] .= add_js('js/data/pengumuman.js');

		$mainData['mainContent']  = $this->load->view('download/vpengumuman', $output,true);
		$this->load->view('vbase',$mainData);
	}

	function json()
	{
		$data = $this->download_model->get_pengumuman();
		print_r($data);
	}
	...
	{		
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$output['channels'] = $this->download_model->get_channel_pengumuman();
			
			$mainData['mainContent'] = $this->load->view('download/vpengumuman_form', $output, TRUE);
