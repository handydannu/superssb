	            ...
	            <div class="panel-body">
	                <form class="form-horizontal bucket-form" method="post" id="formID" name="formID" action="<?= $action_url ?>" enctype="multipart/form-data">
	                    ...
	                    <div class="form-group">
		                    ...
		                    <div class="col-md-2">
		                      <div class="input-group bootstrap-timepicker">
		                        <input class="form-control" id="timepicker-24h" type="text" name="pubtime" value="<?= (isset($EDIT['c_publish_date']))? $ptime : date('H:i:s'); ?>">
	                    ...
	                    <div class="form-group">
                            ...
                            <div class="col-md-2">
                              <select name="channel" data-prompt-position="topRight:40,5" class="select2-container select2able select2-container-active" id="channel">
                              	<option value=""></option>
                              	<?php
						...
						*/ ?>
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control validate[required]" value="<?= (empty($EDIT['c_slug'])) ? '' : $EDIT['c_slug'] ?>" id="slug" name="slug">
	                        </div>
	                    </div>
	                    <div class="form-group">
                        ...
                        <?php if ($mode=='EDITING' && $EDIT['c_content_type']=='video')
	                     {
	                     ...
	                     ?>
                        <!-- Modal Window - TIPE KONTEN -->
                        <div class="form-group" style="<?=$_style?>" id="div_youtube">
                        ...
                        <?php if ($mode=='EDITING' && $EDIT['c_feature']==1)
	                     ...
	                     // ------ Upload Image For Headline -----
	                     ?>
                        <div class="form-group block-local-image" style="<?=$author_style;?>" id="headline_img">
	                        <label class="col-sm-2 control-label">Image Headline</label>
	                        <div class="col-sm-8">
                                <div class="form-group" style="margin-left:1px;">
                    				<input id="file-4" type="file" data-show-upload="false" accept="image/*" name="hfile">
	                            	<span class="help-block"><p><span class="label label-danger">NOTE!</span></p>
	                            		<span>* Maximum size: <strong>150 Kb</strong></span><br />
	                            		<span>* Dimension must be <strong>1200 × 500 pixel</strong></span><br />
	                            		<span>* File extension: <strong>JPEG (.jpg), PNG (.png)</strong></span><br />
	                            	</span>
                                </div>	                            
	                        </div>
...
var img_headline = "<?php echo (empty($EDIT['c_images_content']))? '' : $EDIT['c_images_headline']; ?>";
var BASE   = "<?php echo base_url() ?>";

$("#file-3").fileinput({
  <?php if (!empty($EDIT['c_images_content'])): ?>
  initialPreview: ["<img src='"+BASE+"images-data/posts/"+YEAR+"/"+MONTH+"/"+DATE+"/"+ID+"/"+IMAGES+"' class='file-preview-image' />"],
  <?php endif; ?>
...
$("#file-4").fileinput({
  <?php if (!empty($EDIT['c_images_content'])): ?>
  initialPreview: ["<img src='"+BASE+"images-data/posts/"+YEAR+"/"+MONTH+"/"+DATE+"/"+ID+"/headline/"+img_headline+"' class='file-preview-image' />"],
  <?php endif; ?>
