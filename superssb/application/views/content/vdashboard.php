        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <table class="table table-hover general-table">
                    ...
                    <tr>
                        <td><?php echo $i; ?></td>
                        <td><?php echo date('d-M-Y, H:i', strtotime($row['contact_created'])); ?></td>
                        <td><?php echo $row['contact_name']; ?></td>
                        <td><?php echo $row['contact_email']; ?></td>
                        <td><?php echo html_entity_decode($row['contact_title']); ?></td>
                        <td><?php echo html_entity_decode($row['contact_content']); ?></td>
                    </tr>
                    <?php $i++; } ?>
                    </tbody>
                </table>
