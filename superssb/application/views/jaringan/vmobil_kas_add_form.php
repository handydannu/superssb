	    ...
	    <div class="col-sm-12">
	        <section class="panel">
	            ...
	            <div class="panel-body">
	            	<?php 
		            	$fields = array('mk_id', 'mk_name', 'mk_address','mk_status', 'mk_created');
	                ...
	                <form class="form-horizontal bucket-form" method="post" enctype="multipart/form-data" id="formID" name="formID">
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control validate[required]" value="<?= htmlspecialchars_decode($EDIT['mk_name']); ?>" id="mk_name" name="mk_name">
	                        </div>
	                    </div>
	                    <div class="form-group">
		                    ...
		                    <div class="col-md-2">
		                      <div class="input-group date datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd">
		                        <input class="form-control" type="text" name="mk_created" value="<?= (!empty($EDIT['mk_created'])) ? $EDIT['mk_created'] : date( 'Y-m-d'); ?>">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                        	<textarea name="mk_address" class="form-control validate[required]" rows="5"><?php echo htmlspecialchars_decode($EDIT['mk_address']); ?></textarea>                           
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-sm-2 control-label">Status</label>
	                        <div class="col-sm-2">
	                            <select class="form-control" name="mk_status">
	                            	<option value="0" <?= (empty($EDIT['mk_status']) && $EDIT['mk_status'] != 0 || $EDIT['mk_status'] == 'active' ) ? 'selected="0"' : ''; ?>>Active</option>
	                            	<option value="1" <?= ($EDIT['mk_status'] == '1' && $EDIT['mk_status'] !='') ? 'selected="selected"' : ''; ?>>Not Active</option>
	                            </select>
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-sm-2 control-label">&nbsp;</label>
	                        <input type="hidden" name="mk_created" value="<?php echo (empty($EDIT['mk_created']))? '' : $EDIT['mk_created']; ?>">
	                        <input type="hidden" name="mk_id" value="<?php echo (empty($EDIT['mk_id']))? '' : $EDIT['mk_id']; ?>">
