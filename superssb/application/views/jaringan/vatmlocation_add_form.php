	    ...
	    <div class="col-sm-12">
	        <section class="panel">
	            ...
	            <div class="panel-body">
	            	<?php 
		            	$fields = array('atm_id', 'atm_location', 'atm_address','atm_status', 'atm_created');
	                ...
	                <form class="form-horizontal bucket-form" method="post" enctype="multipart/form-data" id="formID" name="formID">
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control validate[required]" value="<?= htmlspecialchars_decode($EDIT['atm_location']); ?>" id="atm_location" name="atm_location">
	                        </div>
	                    </div>
	                    <div class="form-group">
		                    ...
		                    <div class="col-md-2">
		                      <div class="input-group date datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd">
		                        <input class="form-control" type="text" name="atm_created" value="<?= (!empty($EDIT['atm_created'])) ? $EDIT['atm_created'] : date( 'Y-m-d'); ?>">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                        	<textarea name="atm_address" class="form-control validate[required]" rows="5"><?php echo htmlspecialchars_decode($EDIT['atm_address']); ?></textarea>                           
	                        </div>
	                    </div>                   
	                    <div class="form-group">
	                        <label class="col-sm-2 control-label">Status</label>
	                        <div class="col-sm-2">
	                            <select class="form-control" name="atm_status">
	                            	<option value="0" <?= (empty($EDIT['atm_status']) && $EDIT['atm_status'] != 0 || $EDIT['atm_status'] == 'active' ) ? 'selected="0"' : ''; ?>>Active</option>
	                            	<option value="1" <?= ($EDIT['atm_status'] == '1' && $EDIT['atm_status'] !='') ? 'selected="selected"' : ''; ?>>Not Active</option>
	                            </select>
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-sm-2 control-label">&nbsp;</label>
	                        <input type="hidden" name="atm_id" value="<?php echo (empty($EDIT['atm_id']))? '' : $EDIT['atm_id']; ?>">
