...
<head>
    ...
    <meta name="description" content="New Admin Panel Bisnis.com">
    <meta name="author" content="BIS">
    <link rel="shortcut icon" href="<?= images_uri() ?>favicon.png">
    <title>New Admin Panel Bisnis.com</title>
    ...
    <link href="<?= template_uri() ?>css/style.css?1" rel="stylesheet">
...
<body class="lock-screen" onload="startTime()">
    ...
    <div class="lock-wrapper">
        ...
        <div class="lock-box text-center">
            <div class="lock-name"><?= isset($CU->username) ? $CU->username : 'Guest'; ?></div>
            <img src="<?= images_uri() ?>lock_thumb.jpg" alt="lock avatar"/>
            <div class="lock-pwd">
