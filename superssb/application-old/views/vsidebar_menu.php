        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                */?>
                ...
                <li class="sub-menu">
                <?php
                $content_array = array('csr', 'berita', 'locked', 'photo', 'trash', 'photo', 'video');
                ?>
                    <a href="javascript:;" <?= (in_array($active_menu, $content_array)) ? "class='active'":"" ?>>
                ...
                <li class="sub-menu">
                <?php
                $content_array = array('annual-report', 'laporan_keuangan', 'gcg', 'data-lainnya', 'lelang', 'sbdk');
                ?>
                    <a href="javascript:;" <?= (in_array($active_menu, $content_array)) ? "class='active'":"" ?>>
                ...
                <?php // ========== SETTING ============
                $set_array = array('channels', 'user', 'features', 'province', 'header-image');
                ?>
                <li class="sub-menu">
                    <a href="javascript:;" <?= (in_array($active_menu, $set_array)) ? "class='active'":"" ?>>
