...
class Download_model extends CI_Model
{
	...
	function get_documents($channelID)
	{
		...
		$sql_where 		= '';
		$cols 			= array( "doc_id", "", "doc_title", "doc_year", "doc_summary", "doc_file" );
		$sort 			= "desc";
		...
		// Grab Data
		$sql = "SELECT doc_id, doc_title, doc_summary, doc_file, doc_created_date, doc_modified_date, doc_year, doc_channel_id 
	...
	{		
		...
		// Grab Data
		$sql = "SELECT doc_id, doc_title, doc_summary, doc_file, doc_created_date, doc_modified_date, doc_year, doc_channel_id, ch_name 
				FROM {$this->doc} d 
